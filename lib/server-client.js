...
module.exports = {
    ...
    _connect: function () {
        ...
        socket.on("connect", function () {
            ...
            var slavesSetter = function (e) { this.slaves = e.slaves; }.bind(this);
            this._pubsubClient.on("slave:captured", slavesSetter);
            this._pubsubClient.on("slave:freed", slavesSetter);
        }.bind(this));
