...
module.exports = {
    create: function (id, multicastMiddleware) {
        ...
        client.multicastMiddlewareClient = multicastMiddleware.createClient();
        client.multicastMiddlewareClient.url = client.url + "/messages"
        client.scripts = [];
        ...
        client.scripts.push({
            ...
            read: function (done) {
                    ...
                    messagingUrl: client.multicastMiddlewareClient.url,
                    messagingClientId: client.multicastMiddlewareClient.clientId
                }) + ";");
            }
        });
