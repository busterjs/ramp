...
module.exports = {
    ...
    create: function (busterResources, sessionMiddleware, server) {
        ...
        bindToBayeuxDisconnect.call(instance, server);
...
function bindToBayeuxDisconnect(server) {
    server.bayeuxServer.bind("disconnect", function (clientId) {
        this.destroyClientByBayeuxClientId(clientId);
    }.bind(this));
}