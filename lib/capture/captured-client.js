...
module.exports = {
    create: function (captureMiddleware) {
        ...
        this.captureMiddleware = captureMiddleware;
    ...
    respond: function (req, res, pathname) {
        ...
        if (req.method == "POST" && pathname == this.createMulticastUrl) {
            this.captureMiddleware.multicastMiddleware.createClientFromRequest(req, res, function (multicastClient) {
    ...
    createScriptServingMiddleware: function () {
        ...
        middleware.requireFile(require.resolve("buster-core").replace("buster-core.js", "buster-event-emitter.js"));
