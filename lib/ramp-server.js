...
function performCapture(rampServer, req, res) {
    ...
    mori.get(rampServer, "atoms").allSlaves = mori.conj(mori.get(rampServer, "atoms").allSlaves, slave);
...
module.exports.createRampServer = function () {
    ...
    mori.get(rampServer, "atoms").allSlaves = mori.set();
    ...
    fayeAdapter.getClient().subscribe("/slave_ready", function (e) {
        var slave = mori.first(mori.filter(function (slave) { return mori.get(slave, "id") === e.slaveId}, mori.get(rampServer, "atoms").allSlaves));
