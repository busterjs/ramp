...
function createSession(rampServer, logger, req, res) {
    ...
    when_pipeline([
        ...
        function (body) {
            return when_pipeline([
                function () {
                    ...
                    return rampResources.deserialize(body.resourceSetValue);
                },
                ...
                function (resourceSet) {
                    return {
                        ...
                        rampClientId: body.rampClientId,
        ...
        return rampSession.createSession(e.resourceSet, e.rampClientId, e.options)
