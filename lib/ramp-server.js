...
module.exports.createRampServer = function (opts) {
    ...
    fayeAdapter.getClient().subscribe("/slave_heartbeat", function (e) {
        ...
        if (mori.has_key(mori.get(rampServer, "atoms").allSlaves, slaveId)) {
            mori.get(rampServer, "atoms").slaveHeartbeats = mori.assoc(mori.get(rampServer, "atoms").slaveHeartbeats, slaveId, new Date().getTime());
        } else {
