...
function showSlaveIdle(rampServer, req, res) {
    ...
    res.end("<p>Waiting for some work...</p>" +
            "<p>If you don't know how to use me, please refer to the " +
            "<a href=\"http://docs.busterjs.org/en/latest/overview/\" target=\"_blank\">" +
            "developer overview</a>.</p>");
}
