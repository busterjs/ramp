...
module.exports = buster.extend(buster.eventEmitter.create(), {
    create: function (payload, resourceSet, httpServer) {
        ...
        createBayeux.call(session, httpServer);
        return session;
    },

    respond: function (req, res) {
        if (req.url == this.rootPath && req.method == "DELETE") {
