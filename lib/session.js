...
module.exports = buster.extend(buster.eventEmitter.create(), {
    ...
    started: function () {
        ...
        this._privatePubsubClient.emit("session:started", {
    ...
    loaded: function (slaves) {
        ...
        this._privatePubsubClient.emit("session:loaded", {
            session: this.serialize()
        });
    },
    ...
    aborted: function (err) {
        ...
        this._privatePubsubClient.emit("session:aborted", {
            session: this.serialize(),
            error: err
        });
    },
    ...
    ended: function () {
        ...
        this._privatePubsubClient.emit("session:ended", {
            session: this.serialize()
        });
    },
    ...
    unloaded: function () {
        ...
        this._privatePubsubClient.emit("session:unloaded", {
            session: this.serialize()
        });
    },
