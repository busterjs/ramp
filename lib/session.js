...
module.exports = bane.createEventEmitter({
    create: function (sessionData, pubsubServer) {
        ...
        instance.pubsubClientId = sessionData.pubsubClientId;
        delete sessionData.pubsubClientId;
    ...
    freedSlave: function (slave, slaves) {
        this._privatePubsubClient.publish("/slaveFreed", {
    ...
    _pubsubServerAttach: function (pubsubServer) {
        pubsubServer.onDisconnect(this.pubsubClientId).then(function () {
            this._end();
        }.bind(this));
        ...
        this._privatePubsubClient.subscribe("/end", function () {
            this._end();
        }.bind(this));

        this._privatePubsubClient.subscribe("/initialize", function (e) {
