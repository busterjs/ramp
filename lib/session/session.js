...
function createBayeux() {
    var bayeuxClientPath = this.rootPath + "/messaging";
    this._bayeux = new faye.NodeAdapter({mount: bayeuxClientPath});
    this._bayeux.attach(this._server.httpServer);
    this.bayeuxClientUrl = this._server.address + bayeuxClientPath;
}
