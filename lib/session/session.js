...
module.exports = {
    create: function (data, busterResources, server) {
        ...
        createResourceSet.call(session, data.resourceSet);
    ...
    destroy: function () {
        this._busterResources.removeResourceSet(this.resourceSet);
...
function createResourceSet(data) {
    ...
    this.resourceSet = this._busterResources.createResourceSet(data);
