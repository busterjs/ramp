...
module.exports = buster.extend(buster.eventEmitter.create(), {
    create: function (resourceMiddleware, pubsubServer) {
        ...
        instance.headerFramePath = "/slaves/" + instance._id + "/prison-header/";
    ...
    setHeader: function (height, resourceSet) {
        ...
        this._resourceMiddleware.mount(this.headerFramePath, resourceSet);
    },

    teardown: function () {
        this._resourceMiddleware.unmount(this.prisonPath);
        this._resourceMiddleware.unmount(this.headerFramePath);
