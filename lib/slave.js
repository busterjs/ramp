...
module.exports = buster.extend(buster.eventEmitter.create(), {
    create: function (resourceMiddleware, pubsubServer) {
        ...
        instance._attachResourceSet(resourceMiddleware);
        instance._attachPubsubServer(pubsubServer);
    ...
    _attachResourceSet: function (resourceMiddleware) {
        ...
        resourceMiddleware.mount(prisonPath, prisonResourceSet);
    },

    _attachPubsubServer: function (pubsubServer) {
        this._pubsubClient = pubsubServer.createClient();
