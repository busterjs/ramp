...
module.exports = bane.createEventEmitter({
    ...
    teardown: function () {
        ...
        this._pubsubClient.unsubscribeAll();
    },
    ...
    loadSession: function (session) {
        ...
        var event = "/slave/" + this._id + "/sessionLoad";
        this._pubsubClient.publish(event, session.serialize());
        return this._loadSessionDeferred;
    },

    unloadSession: function () {
        this._unloadSessionDeferred = when.defer();
        this._pubsubClient.publish("/slave/" + this._id + "/sessionUnload");
    ...
    _onImprisoned: function (e) {
        ...
        this._pubsubServer.onDisconnect(e.pubsubClientId, function () {
            self.end();
        });
        this.isReady = true;
    ...
    _attachPubsubServer: function () {
        ...
        this._pubsubClient.subscribe(
            "/slave/" + this._id + "/sessionLoaded",
            this._onSessionLoaded.bind(this)
        );
        this._pubsubClient.subscribe(
            "/slave/" + this._id + "/sessionUnloaded",
