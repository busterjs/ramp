...
(function (GLOBAL) {
    ...
    function loadSession(sessionFrame, session, fayeClient) {
        ...
        GLOBAL.INJECT_BUSTER_INTO_SESSION_FRAME = function (SESSION_FRAME_GLOBAL) {
            ...
            SESSION_FRAME_GLOBAL.buster.emit = function (event, data) {
                ...
                return GLOBAL.FAYE_EVENT_LISTENING_UTILS.fayeSubscriptionPromise(publication);
            };
            ...
            SESSION_FRAME_GLOBAL.buster.on = function (event, handler) {
                ...
                return GLOBAL.FAYE_EVENT_LISTENING_UTILS.fayeSubscriptionPromise(subscription);
            };
        };
    };
    ...
    GLOBAL.LOAD_SLAVE_CHAINS = function () {
        ...
        when.all([
            GLOBAL.FAYE_EVENT_LISTENING_UTILS.fayeSubscriptionPromise(
            ...
            fayeClient.publish("/slaves/" + slaveId + "/slaveReady", {});
        });
    };
}(this))
