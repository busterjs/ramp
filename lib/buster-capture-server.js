...
exports.create = function () {
    ...
    function loadCurrentSession() {
        ...
        captureServer.bayeux.publish("/session/start", sessions[0].serialize());
    ...
    function createSlave() {
        var slave = bCapServSlave.create(captureServer, bayeuxServer, resourcesMiddleware, sessions[0]);
