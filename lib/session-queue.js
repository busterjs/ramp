...
module.exports = {
    ...
    addSlave: function (slave) {
        slave.prepare().then(function () {
            ...
            var slaves = this.slaves.map(function (s) { return s.serialize() });
            this.emit("slave:captured", {slave: slave.serialize(), slaves: slaves});
        ...
        slave.on("end", function () {
            ...
            var slaves = this.slaves.map(function (s) { return s.serialize() });
            this.emit("slave:freed", {slave: slave.serialize(), slaves: slaves});
        }.bind(this));
    },
