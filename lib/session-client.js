...
module.exports = {
    create: function (host, port, opts) {
        ...
        instance.session = opts.session;
        instance.userMessagingContextPath = instance.session.messagingPath + "/user";

        var setupPath = instance.session.messagingPath + "/initialize";
