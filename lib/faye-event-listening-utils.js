...
(function (GLOBAL) {
    ...
    function fayeSubscriptionPromise(subscription) {
    ...
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        module.exports.fayeSubscriptionPromise = fayeSubscriptionPromise
        ...
        GLOBAL.FAYE_EVENT_LISTENING_UTILS = {
            on: on,
            emit: emit,
            fayeSubscriptionPromise: fayeSubscriptionPromise
        };
    }
}(this));
