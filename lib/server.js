...
var bPubsubServer = require("./pubsub-server");
...
module.exports = {
    create: function () {
        ...
        instance.pubsubServer = bPubsubServer.create(null, "/messaging");
    ...
    _createSessionFromRequest: function (body, res) {
        ...
        bSession.create(sessionData, this.pubsubServer).then(function (session) {
