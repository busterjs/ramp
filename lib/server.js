...
module.exports = {
    create: function () {
        ...
        instance.pubsubServer = bCapServPubsubServer.create(null, "/messaging");
        instance.sessionQueue = bCapServSessionQueue.create();
        ...
        instance._pubsubClient = bCapServPubsubClient.create({
            fayeClient: instance.pubsubServer.getClient()
        });
    ...
    attach: function (httpServer) {
        this.pubsubServer.attach(httpServer);
    ...
    _createSessionFromRequest: function (body, res) {
        ...
        bCapServSession.create(sessionData, this.pubsubServer).then(function (session) {
    ...
    _createSlave: function () {
        var slave = bCapServSlave.create();
