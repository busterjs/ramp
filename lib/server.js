...
module.exports = {
    ...
    slaves: function () {
        return this._sessionQueue.slaves.slice();
    },
    ...
    _respond: function (req, res) {
        ...
        if (req.method == "GET" && (SLAVE_RE).test(url.path)) {
            ...
            var allSlaves = this._sessionQueue.slaves.concat(this._sessionQueue.preparingSlaves);
            var slave = allSlaves.filter(function (s) {
                return s._id == uuid;
            })[0];
